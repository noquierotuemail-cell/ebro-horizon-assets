  ...
  const rewritten = new HTMLRewriter()
    ...
    .on("head", {
      element(element) {
        ...
        element.append('<link rel="stylesheet" href="/css/chatkit.css?v=20260903-guide-2">', { html: true });
      }
    })
    .on("body", {
      element(element) {
        element.append('<script src="/js/chatkit-launcher.js?v=20260903-guide-2" defer></script>', { html: true });
      }
    })
    .transform(response);
